  ...
  <Row>
      ...
      <Row>
        <i-col>
          <Card style="margin: 0 5px 5px; text-align: center;">
            ...
            <p class="icon-code">ViewUI内置图标</p>
    ...
    <i-col span="8">
      <Card>
        ...
        <p class="intro-p"><Icon style="margin-right: 10px;" :size="10" type="heart"/>CommonIcon组件同时支持ViewUI内置图标类型和自定义图标类型，为了区别这两种类型，需要在自定义图标名称前加下划线"_"</p>
      </Card>
    </i-col>
  </Row>
</template>
